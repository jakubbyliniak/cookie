...
(function($) {
    $.fn.viewScroller = function(params) {
        ...
        //  CUSTOM FINCTIONS
        //  Returns current site state
        $.fn.viewScroller.lookInTheBag = function(){
            return allBagObjs;
        }
        //  Returns number of views in main bag
        $.fn.viewScroller.numberOfViews = function(){
            var n = allBagObjs[0].viewsData.views.length;
            return n;
        }
        //  Returns current view index
        $.fn.viewScroller.currentIndex = function(){
            var i = allBagObjs[0].viewsData.activeView;
            var pos = i.slice(0, i.search('#'));
            return pos;
        }
